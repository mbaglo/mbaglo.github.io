...
<img src="/assets/img/gloria_mbaka_rit.jpg" alt="Chinyere Gloria Mbaka at RIT" style="width: 100%; max-width:1100px; display: block; margin: 0 auto 2rem auto; border-radius: 2.5rem; box-shadow: 0 10px 30px rgba(0,0,0,0.12);">
...
<div style="display: flex; gap: 1rem; flex-wrap: wrap; justify-content: flex-start; margin: 3rem 0 0 0;">
  ...
  <div style="flex:1 1 220px; max-width:260px; background:#eafcf4; border-radius:1em; padding:1.2em; border:1.5px solid #87dec3;">
    <b>CV & Papers</b><br>
    <span style="color: #019d6a;">Published work and resume.</span><br>
    <a href="/cv/" style="color: #019d6a; text-decoration: underline;">CV & publications</a>
  </div>
